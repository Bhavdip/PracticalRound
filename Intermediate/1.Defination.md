...
- You have to develop an application which has minimal function such as insert a website name, URL, useranem, and password as input. Click on save button will persist the record in local database or server.
